---
title: "Lab - Absenteeism at Work"
author: "jungbin lee (ID : 1235143431)"
date: "`r Sys.Date()`"
output: pdf_document
---
...
# As you can see in the boxplot the medium of smoke people absence hour is much higher than people who don't smoke
```
...
legend("bottomright", inset = c(0,-2),legend = c("drinker", "Non-drinker"), fill = c('red', 'blue'))
...
# As you can see in the boxplot the medium of drink people absence hour is much higher than people who don't drink
```
